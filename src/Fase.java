...
public class Fase {
    ...
    public Fase(Equipa casa,Equipa visitante,int golos,int equipa, int fase,Jogador a,HashMap<String,List<Integer>> mdc, HashMap<String,List<Integer>> mv,ArrayList<Integer> ec,ArrayList<Integer> sc,ArrayList<Integer> ev,ArrayList<Integer> sv){
    ...
    public int getComecou(){return this.comecou;}
    ...
    public void result(int a){
        if (a == 90) System.out.println("Jogo chegou ao fim");
        else System.out.println("Jogo Chegou aos Intervalo");
    ...
    public void getState(int equipaAtacante,int fase,Jogador bola){
           if (this.time == 45){
               ...
               System.out.println("Intervalo do jogo: \n");
               this.result(45);
               System.out.println(" Subsituições da equipa casa : \n");

               // subs da equipa casa
              ArrayList<Integer> subsCasa = this.getEntracasa();
               ArrayList<Integer> saicasa = this.getSaicasa();
               for(int i = 0;i<subsCasa.size();i++){
               this.equipaCasa.substituicao((Jogador) this.equipaCasa.getEquipa().get(subsCasa.get(i)), (Jogador) this.equipaCasa.getEquipa().get(saicasa.get(i)));
               }
               System.out.println(" Subsituições da equipa Visitante :");
                // subs da equipa Visitante
               ArrayList<Integer> subsV = this.getEntraVisitante();
               ArrayList<Integer> saiV = this.getSaiVisitante();
               for(int i = 0;i<subsV.size();i++){
                   this.equipaVisitante.substituicao((Jogador) this.equipaVisitante.getEquipa().get(subsV.get(i)), (Jogador) this.equipaVisitante.getEquipa().get(saiV.get(i)));
               }
               ...
               HashMap<String, List<Integer>> bol = this.equipaAtacante == 1 ? modeloCasa : modeloVisitante;
               Medio segpart = new Medio((Medio) com.getEquipa().get(bol.get("Medio").get(0)));
               this.bola = segpart;
        ...
        switch(bola.getClass().getName()) {
            ...
            case "Medio":
                ...
                if (this.fase == 4)
                    System.out.println("Bola começa no meio campo nos pés de " + this.bola.getNomeReduzido());
                ...
                if (luckAv > 15) {
                    ...
                    if (this.fase == 5) {
                        ...
                        if (this.bola.getCab() * Math.random() > guardaredes.getDes() * Math.random()) {
                            ...
                            System.out.println(" Graaaaaaande defesa de " + guardaredes.getNomeReduzido());

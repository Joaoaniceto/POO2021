...
public class main {
    public static void main(String[] args) {
        ...
        Defesa d = new Defesa(13,"Ruben Dias",true,60,60,60,60,60,60,60);
        ...
        GuardaRedes g = new GuardaRedes(1,"Rui Patrício",true,100,100,100,100,100,100,100,100);
        ...
        Defesa d1 = new Defesa(16,"Felipe",true,60,60,60,60,60,60,60);
